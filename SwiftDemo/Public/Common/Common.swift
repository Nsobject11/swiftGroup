...
/*系统以后*/
let IOS7_OR_BEFORE:Bool = UIDevice.current.systemVersion.k_toCGFloat() <= 8.0
let IOS8_OR_LATER:Bool = UIDevice.current.systemVersion.k_toCGFloat() >= 8.0
let IOS9_OR_LATER:Bool = UIDevice.current.systemVersion.k_toCGFloat() >= 9.0
let IOS10_OR_LATER:Bool = UIDevice.current.systemVersion.k_toCGFloat() >= 10.0
let IOS10_OR_BEFORE:Bool = UIDevice.current.systemVersion.k_toCGFloat() < 10.0
