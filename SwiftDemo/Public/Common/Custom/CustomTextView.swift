...
class CustomTextView: UIView,UITextViewDelegate{
    ...
    fileprivate var placeholder:NSString="请输入..."
    ...
    var cornerRadius:CGFloat=0  ///圆角
    var borderWidth:CGFloat=0.0 ///边框
    ...
    func textViewDidChange(_ textView: UITextView) {
        numwords.text = "\(Int(textView.text.count))/\(Int(maxlength))"
        labplaceholder.isHidden = (textView.text.count > 0);
    }
