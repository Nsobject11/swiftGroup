...
class NetworkTools {
    ...
    ///   - success: 成功的回调
    ///   - failture: 失败的回调
    class func request(_ type : MethodType = .post, url : String, params : [String : Any]?,success : @escaping (_ data : Data)->(), failure : ((Int?, String) ->Void)?,isHud:Bool=true) {
        // 1.获取类型
        ...
        func failureHandle(failure: ((Int?, String) ->Void)? , stateCode: Int?, message: String) {
            AlertUtil.showTempInfo(info: message)
...
extension NetworkTools{
    ...
    ///   - success: 成功的回调
    ///   - failture: 失败的回调
    class func GET(url : String, params : [String : Any]?,success : @escaping (_ data : Data)->(), failure : ((Int?, String) ->Void)?,ishud:Bool=true) {
        NetworkTools.request(.get, url: url, params: params, success: success, failure: failure,isHud: ishud)
    }
    ...
    ///   - success: 成功的回调
    ///   - failture: 失败的回调
    class func POST(url : String, params : [String : Any]?,success : @escaping (_ data : Data) ->(), failure : ((Int?, String) ->Void)?,ishud:Bool=true) {
        NetworkTools.request(.post, url: url, params: params,success: success, failure: failure,isHud: ishud)
    }
